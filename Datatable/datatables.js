 ...
 *   https://datatables.net/download/#bs5-5.3.0/dt-1.13.6/af-2.6.0/b-2.4.1/cr-1.7.0
 *
 * Included libraries:
 *   Bootstrap 5 5.3.0, DataTables 1.13.6, AutoFill 2.6.0, Buttons 2.4.1, ColReorder 1.7.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5-5.3.0/dt-1.13.6/af-2.6.0/b-2.4.1/cr-1.7.0",
