<%@ Page Title="" Language="C#" MasterPageFile="~/Operation.Master" AutoEventWireup="true" CodeBehind="SanitationEscalationReportDSHCG.aspx.cs" Inherits="RUWAS.SanitationEscalationReportDSHCG" %>
        ...
        <div class="m-2 pt-2">
            <nav style="--bs-breadcrumb-divider:'>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item h6">Sanitation Escalation Report DSHCG</li>
                </ol>
            </nav>
        </div>
        <div class="justify-content-between">
            <div class="card shadow mb-5 bg-white rounded">
                <div class="card-header text-center h5 alert alert-info">Sanitation Escalation Report DSHCG</div>
                <div class="card-body">
                    <div class="row">
