<%@ Page Title="" Language="C#" MasterPageFile="~/Operation.Master" AutoEventWireup="true" CodeBehind="DistrictPerformanceReportsDSHCG.aspx.cs" Inherits="RUWAS.DistrictPerformanceReportsDSHCG" %>
        ...
        <div class="m-2 pt-2">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item h6">District Performance Reports (DSHCG)</li>
                </ol>
            </nav>
        </div>
        <div class="d-flix justify-content-between">
            <div>
                <div class="card shadow mb-5 bg-white rounded">
                    <div class="card-header text-center h5 alert alert-info">District Performance Reports (DSHCG)</div>
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-floating">
                                                ...
                                                <label for="districtId">District <span>*</span></label>
