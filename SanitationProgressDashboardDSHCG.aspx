<%@ Page Title="" Language="C#" MasterPageFile="~/Operation.Master" AutoEventWireup="true" CodeBehind="SanitationProgressDashboardDSHCG.aspx.cs" Inherits="RUWAS.SanitationProgressDashboardDSHCG" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="m-2 pt-2">
            <nav style="--bs-breadcrumb-divider:'>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item h6">Sanitation Progress Dashboard DWSCG</li>
                </ol>
            </nav>
        </div>
        <div class="justify-content-between">
            <div class="card shadow mb-5 bg-white rounded">
                <div class="card-header text-center h5 alert alert-info">Sanitation Progress Dashboard DWSCG</div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-12 d-flex justify-content-end mt-2">
                                <i id="toggleSearchId" class="fa-solid fa-magnifying-glass text-end mt-2"style="cursor:pointer;"></i>&nbsp;&nbsp;<input type="text" id="searchContractId" class="form-control" style="border-color:#0D6EFD;height:30px" placeholder="Search" title="Search"/></div>
     ...
     <script>
         ...
         let dateDropdown = document.getElementById("financialYrId");
         let currentYear = new Date().getFullYear();
         let earliestYear = 1770;
